...
.run(['$templateCache', function($templateCache) {
  ...
  var template = '<span class="rz-bar-wrapper"><span class="rz-bar"></span></span>' + // 0 The slider bar
              ...
              '<span class="rz-bubble rz-limit rz-limit-floor"></span>' + // 4 Floor label
              '<span class="rz-bubble rz-limit rz-limit-ceil"></span>' + // 5 Ceiling label
...
.factory('RzSlider', ['$timeout', '$document', '$window', 'throttle', function($timeout, $document, $window, throttle)
{
  ...
  Slider.prototype = {
    ...
    {
      console.log('updateHighHandle', newOffset);
    ...
    {
      //console.log('updateSelectionBar', this.selBar, this.selBar.context, this.selBar.context.parentElement.offsetWidth, this.maxH.rzsl, this.minH.rzsl, Math.abs(this.maxH.rzsl - this.minH.rzsl));
      if(Math.abs(this.maxH.rzsl - this.minH.rzsl) + 32 <= this.selBar.context.parentElement.offsetWidth) {
        ...
        this.setWidth(this.selBar, this.selBar.context.parentElement.offsetWidth - 32);
      }
    },
    ...
    {
      var lowTr, highTr;
      console.log('updateCmbLabel', this.maxLab, this.maxLab.context.parentElement.offsetWidth);
      // if (this.minLab.rzsl <= this.maxLab.context.parentElement.offsetWidth-32){
      if(true==true){
